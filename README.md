...
### Правовой дисклеймер и допустимое использование
Этот проект предназначен **только** для законных и добросовестных сценариев: тестирования собственных интеграций, QA/нагрузочных проверок в контролируемой среде, а также исследований автоматизации с явного разрешения владельца канала и платформы.

Запрещается использовать проект для накрутки метрик, обхода ограничений платформы, спама, манипуляции активностью пользователей или любых иных действий, нарушающих правила сервиса.

Пользователь несёт полную ответственность за запуск и последствия использования `streampromoter`, включая соблюдение местного законодательства, правил платформы Kick, а также условий сторонних сервисов (включая OpenAI, если он используется).

Перед использованием обязательно проверьте актуальные Terms of Service / Community Guidelines соответствующих платформ и убедитесь, что ваш сценарий им соответствует.
